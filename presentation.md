...
### [社交工程利用信任，擊潰臺灣資安防線](https://www.ithome.com.tw/news/171984)
iThome 2025.10

社交工程的本質，從來都不是對設備發動技術上的攻擊，而是針對使用者的「信任」發動心理戰術。誠如數發部資安署主任李昱緯所言，社交工程是一場徹頭徹尾的心理戰，駭客正是利用人性中最基本的三個弱點——<mark>對目標的「信任」、對事件的「恐懼」，以及對訊息的「好奇心」</mark>——來操控受害者的行為，讓他們自己主動交出金錢、資料，甚至電腦的帳號權限。

...

儘管攻擊技術不斷進化，但數位發展部資安署主任李昱緯指出，社交工程的核心工具始終圍繞在四個主要樣態：<mark>釣魚郵件</mark>、<mark>惡意簡訊</mark>、<mark>偽冒網站</mark>以及<mark>偽冒檔案</mark>；最終目的不外乎<mark>「竊取資料」</mark>、<mark>「騙取金錢」</mark>，或進一步<mark>「控制電腦」</mark>。他進一步解釋，社交工程本身並不是技術上的攻擊，它攻擊的目標不是使用者的設備，而是攻擊使用者的信任，「社交工程的本質就是一場心理戰術。」他說。
